...
package com.gc.bussiness.login;
...
import com.gc.R;
import com.gc.framework.mvp.TestComponentRule;
...
public class LoginActivityTest {
    ...
    public void checkViewsDisplay() {
        ...
        onView(ViewMatchers.withId(R.id.btn_server_login))
                .check(matches(isDisplayed()));

        onView(ViewMatchers.withText(R.string.login))
                .check(matches(isDisplayed()));

        onView(ViewMatchers.withId(R.id.ib_google_login))
                .check(matches(isDisplayed()));

        onView(ViewMatchers.withId(R.id.ib_fb_login))
                .check(matches(isDisplayed()));
    }
}