...
public class GPUImageFilterTools {
    ...
    public static class FilterAdjuster {
        private final ThreadLocal<Adjuster<? extends GPUImageFilter>> adjuster;

        public FilterAdjuster(final GPUImageFilter filter) {
            if (filter instanceof GPUImageSharpenFilter) {
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new SharpnessAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new SepiaAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new ContrastAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new GammaAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new BrightnessAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new SobelAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new EmbossAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new GPU3x3TextureAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new HueAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new PosterizeAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new PixelationAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new SaturationAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new ExposureAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new HighlightShadowAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new MonochromeAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new OpacityAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new RGBAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new WhiteBalanceAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new VignetteAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new DissolveBlendAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new GaussianBlurAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new CrosshatchBlurAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new BulgeDistortionAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new GlassSphereAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new HazeAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new SphereRefractionAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new SwirlAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new ColorBalanceAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new LevelsMinMidAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new BilateralAdjuster().filter(filter);
                    }
                };
                ...
                adjuster = new ThreadLocal<Adjuster<? extends GPUImageFilter>>() {
                    @Override
                    protected Adjuster<? extends GPUImageFilter> initialValue() {
                        return new RotateAdjuster().filter(filter);
                    }
                };
            }
            else {
        ...
        public boolean canAdjust() {
            return adjuster.get() != null;
        }

        public void adjust(final int percentage) {
            if (adjuster.get() != null) {
                adjuster.get().adjust(percentage);
            }
        }
